...
/* package redbase-0.1.0.0 */
#define VERSION_redbase "0.1.0.0"
#define MIN_VERSION_redbase(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "redbase-0.1.0.0-FlVzKmFUjPK8GKhemx3jod"

#define CURRENT_PACKAGE_KEY "redbase-0.1.0.0-FlVzKmFUjPK8GKhemx3jod"
